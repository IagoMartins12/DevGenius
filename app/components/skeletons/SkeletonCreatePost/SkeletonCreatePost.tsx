...
export const SkeletonCreatePost = () => {
  ...
  return (
    ...
    >
      ...
      <div className='flex'>
        <div className='flex flex-col w-full lg:w-4/12 lg:flex-row lg:gap-x-8 mx-6 my-6  '>
        ...
        <div className='flex flex-col w-full lg:w-8/12 border-2 pb-4 my-6'>
          <div className='flex sm:flex-col gap-y-4 '>
            <div className='flex flex-col gap-y-2 mx-6 mt-3'>
              <Skeleton containerClassName='w-2/12' />
              <Skeleton containerClassName='w-full' height={35} />
            </div>
            <div className='flex flex-col gap-y-2 mx-6 mt-3'>
              <Skeleton containerClassName='w-2/5' />
              <Skeleton containerClassName='w-full h-3/12' height={35} />
            </div>
            <div className='flex flex-col gap-y-2 mx-6 mt-3'>
            ...
            <div className='flex flex-col gap-y-2 mx-6 mt-3'>
              <Skeleton containerClassName='w-2/12' />
              <Skeleton containerClassName='w-full h-3/12' height={140} />
            </div>
